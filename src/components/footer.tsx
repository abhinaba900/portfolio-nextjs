        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-foreground/70 mb-6 max-w-md">
              Building exceptional digital experiences with modern web technologies. Let's create something amazing
              together.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-foreground/70">AI Integration</li>
            </ul>
          </div>
        </div>

        <div className="border-t border-border mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-foreground/60 text-sm">© {currentYear} John Doe. All rights reserved.</p>
          <p className="text-foreground/60 text-sm mt-2 md:mt-0">Designed & Built with ❤️</p>
        </div>
      </div>
    </footer>
  )
